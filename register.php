...
<head>
    ...
    <title>Daftar - Sistem Pakar Paru-Paru</title>
                ...
                <div class="col-md-8 col-lg-6">
                    <div class="card shadow-lg">
                        ...
                        <div class="card-body p-5">
                            ...
                            <form action="proses/register_proses.php" method="POST" novalidate>
                                <div class="mb-4">
                                ...
                                <div class="mb-4">
                                    ...
                                    <div class="invalid-feedback">Harap konfirmasi password Anda.</div>
                                </div>
                            ...
                            <div class="text-center">
                                <p class="mb-0">Sudah punya akun? 
                                    <a href="login.php" class="text-primary text-decoration-none">Masuk di sini</a>
                                </p>
                            </div>
                        </div>
                    </div>
